...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "UTalBus.controller.Navigation": [],
  "UTalBus.model.DevicesModel": [],
  "UTalBus.model.ParaderosModel": [],
  "UTalBus.model.TrackpointsModel": [],
  "UTalBus.store.DevicesStore": [],
  "UTalBus.store.ParaderosStore": [],
  "UTalBus.store.TrackpointsStore": [],
  "UTalBus.view.AboutPanel": [],
  "UTalBus.view.ContactPanel": [],
  "UTalBus.view.DeviceDetails": [],
  "UTalBus.view.DevicePanel": [],
  "UTalBus.view.DevicesPanel": [],
  "UTalBus.view.HomePanel": [],
  "UTalBus.view.Main": [],
  "UTalBus.view.MainView": [],
  "UTalBus.view.NavMenu": [],
  "UTalBus.view.ParaderoPanel": [],
  "UTalBus.view.ParaderosPanel": []
});
